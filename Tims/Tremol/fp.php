...
namespace ThemeFactory\Tims\Tremol {
  require_once('FP_Core.php');
  ...
  class FP extends FP_Core
  {
    ...
    {
      return new \ThemeFactory\Tims\Tremol\CloseReceiptRes($this->execute("CloseReceipt"));
    }
    ...
    {
      return new \ThemeFactory\Tims\Tremol\CUnumbersRes($this->execute("ReadCUnumbers"));
    }
    ...
    {
      return new \ThemeFactory\Tims\Tremol\CurrentReceiptInfoRes($this->execute("ReadCurrentReceiptInfo"));
    }
    ...
    {
      return new \ThemeFactory\Tims\Tremol\DailyAmountsByVATRes($this->execute("ReadDailyAmountsByVAT"));
    }
    ...
    {
      return new \ThemeFactory\Tims\Tremol\DeviceModuleSupportRes($this->execute("ReadDeviceModuleSupport"));
    }
    ...
    {
      return new \ThemeFactory\Tims\Tremol\DeviceModuleSupportByFirmwareRes($this->execute("ReadDeviceModuleSupportByFirmware"));
    }
    ...
    {
      return new \ThemeFactory\Tims\Tremol\DeviceTCP_AddressesRes($this->execute("ReadDeviceTCP_Addresses", "OptionAddressType", $OptionAddressType));
    }
    ...
    {
      return new \ThemeFactory\Tims\Tremol\DiagnosticsRes($this->execute("ReadDiagnostics"));
    }
    ...
    {
      return new \ThemeFactory\Tims\Tremol\EODAmountsRes($this->execute("ReadEODAmounts"));
    }
    ...
    {
      return new \ThemeFactory\Tims\Tremol\GPRS_APNRes($this->execute("ReadGPRS_APN"));
    }
    ...
    {
      return new \ThemeFactory\Tims\Tremol\GPRS_PasswordRes($this->execute("ReadGPRS_Password"));
    }
    ...
    {
      return new \ThemeFactory\Tims\Tremol\GPRS_UsernameRes($this->execute("ReadGPRS_Username"));
    }
    ...
    {
      return new \ThemeFactory\Tims\Tremol\HScodeRes($this->execute("ReadHScode", "HS_Number", $HS_Number));
    }
    ...
    {
      return new \ThemeFactory\Tims\Tremol\HTTPS_ServerRes($this->execute("ReadHTTPS_Server"));
    }
    ...
    {
      return new \ThemeFactory\Tims\Tremol\InfoFromLastServerCommunicationRes($this->execute("ReadInfoFromLastServerCommunication", "OptionServerResponse", $OptionServerResponse, "OptionTransactionType", $OptionTransactionType));
    }
    ...
    {
      return new \ThemeFactory\Tims\Tremol\LastAndTotalReceiptNumRes($this->execute("ReadLastAndTotalReceiptNum"));
    }
    ...
    {
      return new \ThemeFactory\Tims\Tremol\NTP_AddressRes($this->execute("ReadNTP_Address"));
    }
    ...
    {
      return new \ThemeFactory\Tims\Tremol\SpecificMessageRes($this->execute("ReadSpecificMessage", "MessageNum", $MessageNum));
    }
    ...
    {
      return new \ThemeFactory\Tims\Tremol\StatusRes($this->execute("ReadStatus"));
    }
    ...
    {
      return new \ThemeFactory\Tims\Tremol\TCP_PasswordRes($this->execute("ReadTCP_Password"));
    }
    ...
    {
      return new \ThemeFactory\Tims\Tremol\VATratesRes($this->execute("ReadVATrates"));
    }
    ...
    {
      return new \ThemeFactory\Tims\Tremol\WiFi_NetworkNameRes($this->execute("ReadWiFi_NetworkName"));
    }
    ...
    {
      return new \ThemeFactory\Tims\Tremol\WiFi_PasswordRes($this->execute("ReadWiFi_Password"));
    }
